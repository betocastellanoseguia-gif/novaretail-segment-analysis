...
Method
Load data and convert segment to a factor with three levels
Compute descriptive statistics by group (n, mean, standard deviation, min, max)
Visualize: boxplot by segment and mean plot with ±1 SD error bars
Fit a one-way ANOVA (aov) with spending_usd ~ segment
Extract the p-value and evaluate against α = 0.05
Results
